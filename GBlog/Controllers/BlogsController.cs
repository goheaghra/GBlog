...
namespace GBlog.Controllers
{
    public class BlogsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BlogId,Title,Content")] Blog postedBlog)
        {
            if (ModelState.IsValid)
            {
                Blog blog = db.Blogs.Find(postedBlog.BlogId) as Blog;
                blog.Title = postedBlog.Title;
                blog.Content = postedBlog.Content;
                blog.ChangedOn = DateTime.Now;
